...
class TaskController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('MDNTodoBundle:Task')->findAll();
     ...
     * @Method("POST")
     * @Template("MDNTodoBundle:Task:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('MDNTodoBundle:Task')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("MDNTodoBundle:Task:edit.html.twig")
     */
